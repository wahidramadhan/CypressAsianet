describe('API Testing dengan Cypress', () => {
    ...
    Cypress.env('orderNumber', 'OH1098190794357249790');
    Cypress.env('workflow', '202410000134');
    Cypress.env('longit', 107.611169);
    Cypress.env('latid', -6.928117);
    Cypress.env('teamid', 127);
